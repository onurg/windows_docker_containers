...
function GenerateCerts {
	...
	$splat = @{
		Path     = "C:\ProgramData\docker\certs.d\docker.company.net\rootCA.cer";
	...
	$splat = @{
		Path     = "C:\ProgramData\docker\certs.d\docker.company.net\serverCert.cer";
	...
	$splat = @{
		Path     = "C:\ProgramData\docker\certs.d\docker.company.net\privateKey.cer";
	...
	$splat = @{
		Path     = "C:\ProgramData\docker\certs.d\docker.company.net\clientPublicKey.cer" ;
	...
	$splat = @{
		Path     = "C:\ProgramData\docker\certs.d\docker.company.net\clientPrivateKey.cer";
